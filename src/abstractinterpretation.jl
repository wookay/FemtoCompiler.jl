...
using .CC: AbsIntState, _time_ns, warnlength, doworkloop, finish_nocycle, finish_cycle
import .CC: typeinf
# from julia/Compiler/src/abstractinterpretation.jl
# function typeinf(interp::AbstractInterpreter, frame::InferenceState)
function typeinf(interp::FemtoInterpreter, frame::InferenceState)
